...
- **El STT de voz está fijado en español.** La autodetección de Whisper falla
  demasiado en frases cortas (§2.13). El TTS sí selecciona una voz local
  española o inglesa según el texto de la respuesta (§2.5).
