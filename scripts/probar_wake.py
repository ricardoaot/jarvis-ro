...
if disparos:
    ...
    print("  ⚠️  Te reconoce a medias. Prueba a bajar sensitivity a 0.4 y repetir.")
    print("     Suele ser pronunciación: el modelo está entrenado con inglés,")
    print("     y 'jarvis' con jota española suena muy distinto a /DZHAR-vis/.")
else:
